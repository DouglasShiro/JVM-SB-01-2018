...
void inicializa_Conj_Instrucoes(){
	...
	// // Loads
	instrucao[0x15] = decodeiload;
	instrucao[0x16] = decodelload;
	instrucao[0x17] = decodefload;
	instrucao[0x18] = decodedload;
	instrucao[0x19] = decodeaload;
	...
	// //Store
	instrucao[0x36] = decodeistore;
	instrucao[0x37] = decodelstore;
	instrucao[0x38] = decodefstore;
	instrucao[0x39] = decodedstore;
	instrucao[0x3A] = decodeastore;
