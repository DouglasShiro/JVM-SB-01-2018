...
void invokespecial(Frame* frame, Pilha_frames* pilha_frames, u1 index_0, u1 index_1) {
    ...
    // {
    //     argumentos[i] = desempilha_operando(&(frame->pilha_operandos));
    // }
	//
...
void invokevirtual(Frame* frame, Pilha_frames* pilha_frames, u1 index_0, u1 index_1) {
	...
	ClassFile *class_file = NULL;
	float op_f = 0;
	char *class_name = NULL, *method_name = NULL, *method_desc = NULL, *name = NULL, *name_desc = NULL;
	u8 op_8 = 0;
	u4 op_4 = 0, *argumentos = NULL;
	u2 index = 0, index_class = 0, index_desc = 0, index_method = 0;
